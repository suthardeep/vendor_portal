...
const ChartsSection = ({ ordersData, salesData }) => {
  return (
        ...
        <div className="flex-1 p-6 flex flex-col border-r border-base-3">
          ...
          <div className="w-full -mx-2">
            <ResponsiveContainer width="100%" height={240}>
              <BarChart data={ordersData} margin={{ left: 0, right: 0, top: 10, bottom: 10 }}>
        ...
        <div className="p-6">
          ...
          <div className="w-full -mx-2">
            <ResponsiveContainer width="100%" height={200}>
              <AreaChart data={salesData} margin={{ left: 0, right: 0, top: 10, bottom: 10 }}>
                <defs>
