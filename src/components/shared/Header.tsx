...
const Header = () => {
  ...
  return (
    <div className="dark:bg-nd-800 border-b-nl-100 dark:border-b-nd-600 flex w-full items-center justify-between border-b bg-white p-3 sm:px-6 md:px-10 lg:p-4">
      <div className="flex items-center gap-x-3">
        ...
        <h4 className="text-pl-800 dark:text-pd-50 text-left text-lg font-semibold lg:text-xl">
          {title}
        </h4>
      </div>
